...
- **[flow](https://github.com/jeziellopes/flow)** — Real-time trading engine simulator with live Binance market data, built with React 19.2, Vite 8, and the React Compiler.
...
- **[cv](https://github.com/jeziellopes/cv)** — A free, open-source resume generator. Edit cv.json, run one command, get a pixel-perfect HTML file and a print-ready PDF — no third-party login, no subscription, no watermark.
- **[vscdb-fix](https://github.com/jeziellopes/vscdb-fix)** ⭐ 37 — Repair tool for VS Code Copilot Chat sessions that disappear due to corrupted session index in state.vscdb.
<!-- PROJECTS_END -->

<!-- OSS_START -->
### Recent OSS

- ❌ Closed **[fix(copilot): upgrade Copilot CLI hook to transparent updatedInput rewrite (v1.0.24+)](https://github.com/rtk-ai/rtk/pull/1225)** into [rtk-ai/rtk](https://github.com/rtk-ai/rtk)
