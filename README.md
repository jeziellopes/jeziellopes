...
- **[vscdb-fix](https://github.com/jeziellopes/vscdb-fix)** ⭐ 46 — Repair tool for VS Code Copilot Chat sessions that disappear due to corrupted session index in state.vscdb.
<!-- PROJECTS_END -->
